...
v-if="showForm === true" >
  <div class="form-element">
    ...
    <input type="texy" id="reviewer" v-model="newReview.reviewer"/>
  </div>
  <div class="form-element">
    <label for="title">Title:</label>
    <input id="title" v-model="newReview.title"/>
  </div>
  <div class="form-element">
...
export default {
  ...
  computed: {
    ...
    filteredReviews(){
     ...
     return this.starFilter === 0 || review.rating === this.starFilter
      }, 0);
  ...
  methods: {
    addNewReview(){
      const theReview = this.newReview;
      this.reviews.unshift(theReview);
      this.resetForm();
    },
    resetForm(){
      this.newReview={};
    ...
    numberOfStarReviews(numOfStars){
