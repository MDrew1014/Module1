...
public class SandwichCLI {
	...
	private static final String MAIN_MENU_ADD_CATEGORY = "Add or remove a category from sandwich";
	...
	public SandwichCLI() {
		...
		dataSource.setUrl("jdbc:postgresql://localhost:5432/sandwich_shop");
