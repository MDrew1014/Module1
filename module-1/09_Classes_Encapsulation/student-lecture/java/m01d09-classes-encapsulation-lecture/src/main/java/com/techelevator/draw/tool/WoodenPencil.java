...
/*CLASS DECLARATION
 * 
 * PascalCase and they are traditionally singular(BEST PRACTICE)
 * 
 * 
 * 
 */

//access level   class keyword      class name {  <=== this is the standard for every class. A RULE YOU CAN TRUST!!!!
public           class            WoodenPencil {
	...
	//CONSTANTS
	//access     part of the class not the instance		variable cannot change				regular variable declaration
	//              always the same	one time		can only be written on time
	public           static									 final			 				double defaultLength = 8.0;
	//						you do not want mutable static values so always final
	...
	private Color color;// color of exterior
	...
	public int getShape() {
		//audit and count that this was called. Can use to calculate methods
		return shape;
			}
	...
	// boolean type things we replace get with IS
	public boolean isFavorite() {
		return favorite;	
	
	}	// void returns no value it is just a statement setters are void methods
	 ...
	 * CONSTRUCTOR
	 * 
	 * does not have a return type and has same name as the class itself and will be public
	 * called once and only once for every object 
	 * 
	 */
	
	// Empty Constructor  overloaded methods
	public WoodenPencil() {
	...
	public static void main(String[] args) {
		...
		//call the full constructor arguments
