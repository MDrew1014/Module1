...
public class Exercises {
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
    	if(mealAmount <= 10.00 && isBirthday == false) {
    		return "standard";
    	}else if(mealAmount + 5.00 <= 10.00 && isBirthday == true) {
    		return "standard";
    	}else if(mealAmount >= 10.00 && mealAmount <= 15.00 && isBirthday == false) {
    		return "special";
    	}else if(mealAmount + 5.00 >= 10.00 && mealAmount <= 15.00 && isBirthday == true) {
    		return "special";
    	}{
    		return "ginormous";
    	}
	...
	public String alarmClock(int day, boolean vacation) {
		if(day <=5 && day >=1 && vacation == false) {
			return "7:00";
		} else if(day == 0 ^ day == 6 && vacation == false) {
		return "10:00";
	}else if(day <=5 && day >=1 && vacation == true) {
		return "10:00";
	} {
		return "off";
	}
	...
	public boolean in1To10(int n, boolean outsideMode) {
		if((outsideMode == true && n <=1 ^ n >= 10) ^ (n >= 1 && n<=10 && outsideMode == false)) {
		return true;
		}{
			return false;
		}
